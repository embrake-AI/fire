		...
		mkEvent(
			{
				...
				event_data: {
					...
					title: "Prior deploy regression incident",
					incidentStatus: "resolved",
					summary: "Prior incident had same timeout class right after a connection pool config deploy.",
					similarities: "Rollback + pool reset mitigated in 3 minutes and reduced errors immediately.",
					learnings: "Current timeline matches previous deploy regression",
				},
			},
			5,
		),
		...
		mkEvent(
			{
				...
				event_data: {
					...
					title: "Previous auth rollout incident",
					incidentStatus: "resolved",
					summary: "Previous auth rollout incident with token verifier latency.",
					similarities: "Mitigation used verifier pool tuning and rollout pause.",
					learnings: "Initial hypothesis aligned with token verifier saturation.",
				},
			},
			3,
		),
