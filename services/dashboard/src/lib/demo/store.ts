...
function makeInitialState(): DemoState {
	...
	return {
		...
		slackUsers: [
			...
			{ id: "UDEMO002", name: "Casey Lane", email: "casey@firedash.ai", avatar: undefined },
			{ id: "UDEMO003", name: "Mina Park", email: "mina@firedash.ai", avatar: undefined },
			{ id: "UDEMO004", name: "Ravi Chen", email: "ravi@firedash.ai", avatar: undefined },
		],
		slackChannels: [
			{ id: "CDEMO001", name: "incidents", isPrivate: false, isMember: true },
			{ id: "CDEMO002", name: "ops", isPrivate: false, isMember: true },
			{ id: "CDEMO003", name: "eng-oncall", isPrivate: true, isMember: true },
		],
		slackBotChannels: [
			{ id: "CDEMO001", name: "incidents", isPrivate: false },
			{ id: "CDEMO002", name: "ops", isPrivate: false },
			{ id: "CDEMO003", name: "eng-oncall", isPrivate: true },
		],
		slackEmojis: {
			fire: "\ud83d\udd25",
			rotating_light: "\ud83d\udea8",
