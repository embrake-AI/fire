DROP VIEW "entryPointWithAssignee";--> statement-breakpoint
CREATE VIEW "rotationWithAssignee" AS (select "id", "name", "client_id", date_bin("shift_length", now(), "anchor_at") as "shift_start", "shift_length" as "shift_length", "assignees", 
  CASE
