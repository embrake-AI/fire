...
ALTER TABLE "incident_analysis" ADD COLUMN "team_id" uuid;--> statement-breakpoint
ALTER TABLE "incident_analysis" ADD CONSTRAINT "incident_analysis_team_id_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "team"("id") ON DELETE SET NULL;--> statement-breakpoint
CREATE VIEW "rotationWithAssignee" AS (
	select
		"rotation"."id" as "id",
		"rotation"."name" as "name",
		"rotation"."client_id" as "client_id",
		date_bin("rotation"."shift_length", now(), "rotation"."anchor_at") as "shift_start",
		"rotation"."shift_length" as "shift_length",
 ...
 as "effective_assignee",
  ...
  END
 as "base_assignee",
		"rotation"."created_at" as "created_at",
		"rotation"."updated_at" as "updated_at",
		"rotation"."team_id" as "team_id",
		COALESCE(
			json_agg(
				json_build_object(
 ...
 = "user_integration"."user_id"
	group by
		...
		"rotation"."assignees",
		"rotation"."anchor_at",
		"rotation"."assignee_overwrite",
		"rotation"."override_for_shift_start",
		"rotation"."created_at",
		"rotation"."updated_at",
		"rotation"."team_id"
);